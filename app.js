...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className = "tasks__input tasks__input_check";
    editInput.type="text";
    ...
    deleteButtonImg.className="tasks__button-img";
...
//select ListItems children
    var checkBox=taskListItem.querySelector(".tasks__input_check");
